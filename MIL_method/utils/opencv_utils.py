...
class OpenCV:
    ...
    def find_contours(self,is_binary = False, is_erode_dilate = False, mode=3, thresh=210,
        ...
        if is_binary:
            ...
            morphology = self.gray_binary(thresh=thresh, show=False)
        if is_erode_dilate:
            morphology = self.erode_dilate(morphology, erode_iter=erode_iter, dilate_iter=dilate_iter, show=False)
